...
<script type="text/javascript">window.onload = function() { Calendly.initBadgeWidget({ url: 'https://www.google.com', text: 'Register Here today!', color: '#0069ff', textColor: '#ffffff', branding: undefined }); }</script>
